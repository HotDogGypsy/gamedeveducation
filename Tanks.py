...
fire_sound = pygame.mixer.Sound("KAPEW2.WAV")
...
def game_controls():
    ...
    while gcont:
        ...
        button("Exit",550,500,100,50, red, light_red, action="quit")
...
#Text Fone
smallfont = pygame.font.SysFont("couriernewsms", 25)
medfont = pygame.font.SysFont("couriernewms", 50)
largefont = pygame.font.SysFont("couriernewsms", 80)
...
def e_fireShell(xy, tankx,tanky,turPos,gun_power, xlocation, barrier_width, randomHeight, ptankx, ptanky):
    ...
    while not power_found:
        ...
        while fire:
            ...
            gun_power=random.randrange(int(currentPower*.90), int(currentPower*1.10))
